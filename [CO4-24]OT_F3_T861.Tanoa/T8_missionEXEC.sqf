...
target_diff_4 = 
[
	[ [ _groupArrayTarget4, "t8_zone_inner", "T8u_fnc_bg_gear_target" ], [ "OCCUPY" ], [ true, false, true ] ],
	[ [ _groupArrayFullTeam, "t8_zone_inner", "T8u_fnc_bg_gear" ], [ "OCCUPY" ], [ true, true, true ] ],
	[ [ _groupArrayFireTeam, "t8_zone_mid", "T8u_fnc_bg_gear" ], [ "PATROL_AROUND" ], [ false, true, true ] ]
];

// diff 8: 4+8+6=18
target_diff_8 = 
[
	[ [ _groupArrayTarget8, "t8_zone_inner", "T8u_fnc_bg_gear_target" ], [ "OCCUPY" ], [ true, false, true ] ],
	[ [ _groupArrayFullTeam, "t8_zone_inner", "T8u_fnc_bg_gear" ], [ "OCCUPY" ], [ true, true, true ] ],
	[ [ _groupArrayFullPat, "t8_zone_mid", "T8u_fnc_bg_gear" ], [ "PATROL_AROUND" ], [ false, true, true ] ]
];

// diff 12: 5+8+6+6=25
target_diff_12 = 
[
	[ [ _groupArrayTarget8 + ["O_Soldier_AR_F"], "t8_zone_inner", "T8u_fnc_bg_gear_target" ], [ "OCCUPY" ], [ true, false, true ] ],
	[ [ _groupArrayFullTeam, "t8_zone_inner", "T8u_fnc_bg_gear" ], [ "OCCUPY" ], [ true, false, true ] ],
	[ [ _groupArrayFullPat, "t8_zone_mid", "T8u_fnc_bg_gear" ], [ "PATROL_AROUND" ], [ true, true, true ] ],
	[ [ _groupArrayFullPat, "t8_zone_outer", "T8u_fnc_bg_gear" ], [ "PATROL_AROUND" ], [ true, true, true ] ]
];

// diff 24: 6+4+8+8+8=34
target_diff_24 = 
[
	[ [ _groupArrayTarget8 + ["O_Soldier_AR_F", "O_Soldier_F"], "t8_zone_inner", "T8u_fnc_bg_gear_target" ], [ "OCCUPY" ], [ true, false, true ] ],
	[ [ _groupArrayFireTeam, "t8_zone_inner", "T8u_fnc_bg_gear" ], [ "OCCUPY" ], [ true, false, true ] ],
	[ [ _groupArrayFullTeam, "t8_zone_outer", "T8u_fnc_bg_gear" ], [ "PATROL_AROUND" ], [ true, true, true ] ],
	[ [ _groupArrayFullTeam, "t8_zone_max", "T8u_fnc_bg_gear" ], [ "PATROL_AROUND" ], [ true, true, true ] ],
	[ [ _groupArrayFullTeam, "t8_zone_max", "T8u_fnc_bg_gear" ], [ "PATROL_AROUND" ], [ true, true, true ] ]
];
