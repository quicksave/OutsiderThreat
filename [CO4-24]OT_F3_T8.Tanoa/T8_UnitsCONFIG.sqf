...
T8U_var_PatAroundRange			= 10;			// zone radius + T8U_var_PatAroundRange (e.g. 40 m) is the distance where units will patrole around zones.
...
T8U_var_OvSuperiority			= 999;			// if enemy units have a overwhelwing superiority of 3 : 1 they wont call for help ( checked at that moment when they call for help )
