private ["_side","_typeofUnit","_unit","_typeBackpack"];
...
//if ((_unit isKindOF "CAManBase")&&(_side != toLower (faction (leader group _unit)))) then {_faction = toLower (faction (leader group _unit))};
